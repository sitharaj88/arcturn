...
```bash
arcturn add sitharaj88/arcturn/kits/iac-plan-review
```

That is the GitHub `owner/repo/subdir` shorthand: Arcturn clones the repo, uses
`kits/iac-plan-review` as the package root, pins the resolved commit in
...
```bash
arcturn inspect sitharaj88/arcturn/kits/iac-plan-review
```
...
```bash
arcturn add ./kits/iac-plan-review
...
```bash
arcturn inspect ./kits/iac-plan-review
