...
```bash
arcturn add sitharaj88/arcturn/examples/cloud-posture-review
```

That is the GitHub `owner/repo/subdir` shorthand: Arcturn clones the repo, uses
`examples/cloud-posture-review` as the package root, pins the resolved commit in
...
```bash
arcturn inspect sitharaj88/arcturn/examples/cloud-posture-review
```
...
```bash
arcturn add ./examples/cloud-posture-review
