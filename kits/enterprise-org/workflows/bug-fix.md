...
4. [tier:build] @tech-lead Assemble the evidence packet from the repro, the fix, and the review below. State the fail-before/pass-after result, list any findings, and recommend MERGE, MERGE-WITH-FIXES, or DO-NOT-MERGE with a one-line DECISION-REQUEST. Do not merge. Inputs: {{prev}}
