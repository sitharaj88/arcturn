...
cp kits/enterprise-org/agents/*.md     .arcturn/agents/
cp kits/enterprise-org/workflows/*.md  .arcturn/workflows/
...
const warnings = [];
const defs = await loadAgentDefs(["kits/enterprise-org/agents"], warnings, BUILT_IN_TOOL_NAMES);
