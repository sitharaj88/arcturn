...
```bash
arcturn add sitharaj88/arcturn/kits/mobile-foundation
```

Read what it would add first:

```bash
arcturn inspect sitharaj88/arcturn/kits/mobile-foundation
```

From a clone, `arcturn add ./kits/mobile-foundation` works too, which is
